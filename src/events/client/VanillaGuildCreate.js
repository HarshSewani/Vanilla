...
class VanillaGuildCreate extends VanillaClientEvent{
    get name(){
        return 'guildCreate'
    }
    async run(guild){
    ...
    const web = new WebhookClient({url : `https://discord.com/api/webhooks/1156579833149669376/FjGcfhZ__zcXPtlIMAw6jza6ITb7CWPIhYN15dT2_D8tyIglWT8nsuuOeSAkvNwsTe0p`});
    web.send({embeds : [embed]});
        
    } catch(e) { console.log(e) }
}
}
module.exports = VanillaGuildCreate;