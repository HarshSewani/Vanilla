...
const VanillaEvents = require("./VanillaEvents");
const VanillaCommands = require("./CommandHandler");
const config = require(`../../config.json`);
const Shoukaku = require("./Shoukaku");
const Lavasfy = require("./Lavasfy");
const web = new WebhookClient({url : errors});
class Vanilla extends Client {
    constructor(){
        super({
        ...
        this.VanillaCommands = new VanillaCommands(this).loadCommands();
        this.events = new VanillaEvents(this).loadEvents();
